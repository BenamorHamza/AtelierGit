...
create_dashboard (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), button2, 384, 96);
  gtk_widget_set_size_request (button2, 144, 72);
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), button1, 96, 96);
  gtk_widget_set_size_request (button1, 128, 72);
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), button3, 224, 232);
  gtk_widget_set_size_request (button3, 144, 72);

  alignment11 = gtk_alignment_new (0.5, 0.5, 0, 0);
  gtk_widget_show (alignment11);
  gtk_container_add (GTK_CONTAINER (button3), alignment11);
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), button4, 144, 520);
  gtk_widget_set_size_request (button4, 304, 72);

  alignment12 = gtk_alignment_new (0.5, 0.5, 0, 0);
  gtk_widget_show (alignment12);
  gtk_container_add (GTK_CONTAINER (button4), alignment12);
  ...
  label33 = gtk_label_new_with_mnemonic (_("Capteurs d\303\251fectueux"));
  ...
  GLADE_HOOKUP_OBJECT (dashboard, label33, "label33");
...
create_mod (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed2), mod4, 184, 160);
  gtk_widget_set_size_request (mod4, 160, 40);
  gtk_combo_box_append_text (GTK_COMBO_BOX (mod4), _("A"));
  gtk_combo_box_append_text (GTK_COMBO_BOX (mod4), _("B"));
  gtk_combo_box_append_text (GTK_COMBO_BOX (mod4), _("C"));
  ...
  gtk_fixed_put (GTK_FIXED (fixed2), label30, 72, 168);
...
create_aj (void)
{
  ...
  gtk_widget_show (ajc);
  gtk_fixed_put (GTK_FIXED (fixed4), ajc, 168, 256);
  ...
  label13 = gtk_label_new (_("R\303\251f\303\251rence :"));
  ...
  gtk_fixed_put (GTK_FIXED (fixed4), label16, 8, 264);
  ...
  gtk_fixed_put (GTK_FIXED (fixed4), label31, 32, 192);
  ...
  gtk_widget_show (aj4);
  gtk_fixed_put (GTK_FIXED (fixed4), aj4, 200, 192);
  gtk_widget_set_size_request (aj4, 116, 24);
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (aj4), aj4_group);
  aj4_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (aj4));

  aj5 = gtk_radio_button_new_with_mnemonic (NULL, _("B"));
  gtk_widget_show (aj5);
  gtk_fixed_put (GTK_FIXED (fixed4), aj5, 400, 192);
  gtk_widget_set_size_request (aj5, 116, 24);
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (aj5), aj4_group);
  aj4_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (aj5));

  aj6 = gtk_radio_button_new_with_mnemonic (NULL, _("C"));
  gtk_widget_show (aj6);
  gtk_fixed_put (GTK_FIXED (fixed4), aj6, 608, 192);
  gtk_widget_set_size_request (aj6, 116, 24);
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (aj6), aj4_group);
  aj4_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (aj6));
...
create_aj_mesure (void)
{
  ...
  gtk_widget_set_size_request (aj_mesure, 784, 800);
  ...
  gtk_fixed_put (GTK_FIXED (fixed5), ajm3, 176, 176);
  gtk_widget_set_size_request (ajm3, 168, 40);
  gtk_entry_set_invisible_char (GTK_ENTRY (ajm3), 8226);

  ajm1 = gtk_entry_new ();
  gtk_widget_show (ajm1);
  gtk_fixed_put (GTK_FIXED (fixed5), ajm1, 176, 40);
  gtk_widget_set_size_request (ajm1, 144, 32);
  gtk_entry_set_invisible_char (GTK_ENTRY (ajm1), 8226);

  label17 = gtk_label_new (_("ID :"));
  gtk_widget_show (label17);
  gtk_fixed_put (GTK_FIXED (fixed5), label17, 72, 48);
  gtk_widget_set_size_request (label17, 40, 16);

  label19 = gtk_label_new (_("Type :"));
  gtk_widget_show (label19);
  gtk_fixed_put (GTK_FIXED (fixed5), label19, 32, 104);
  ...
  gtk_fixed_put (GTK_FIXED (fixed5), ajm2, 176, 104);
  gtk_widget_set_size_request (ajm2, 168, 40);
  gtk_combo_box_append_text (GTK_COMBO_BOX (ajm2), _("Temp\303\251rature"));
  gtk_combo_box_append_text (GTK_COMBO_BOX (ajm2), _("D\303\251bit d'eau"));
  gtk_combo_box_append_text (GTK_COMBO_BOX (ajm2), _("Mouvement"));
  gtk_combo_box_append_text (GTK_COMBO_BOX (ajm2), _("Fum\303\251e"));
  ...
  h_adj = gtk_adjustment_new (0, 0, 23, 1, 10, 10);
  h = gtk_spin_button_new (GTK_ADJUSTMENT (h_adj), 1, 0);
  gtk_widget_show (h);
  gtk_fixed_put (GTK_FIXED (fixed5), h, 448, 448);
  gtk_widget_set_size_request (h, 60, 27);

  m_adj = gtk_adjustment_new (0, 0, 59, 1, 10, 10);
  m = gtk_spin_button_new (GTK_ADJUSTMENT (m_adj), 1, 0);
  gtk_widget_show (m);
  gtk_fixed_put (GTK_FIXED (fixed5), m, 528, 448);
  gtk_widget_set_size_request (m, 60, 27);

  label27 = gtk_label_new (_(":"));
  gtk_widget_show (label27);
  gtk_fixed_put (GTK_FIXED (fixed5), label27, 512, 448);
  gtk_widget_set_size_request (label27, 16, 32);

  label26 = gtk_label_new (_("Temps :"));
  gtk_widget_show (label26);
  gtk_fixed_put (GTK_FIXED (fixed5), label26, 448, 408);
  gtk_widget_set_size_request (label26, 152, 32);

  button_ajm = gtk_button_new_with_mnemonic (_("Ajouter"));
  gtk_widget_show (button_ajm);
  gtk_fixed_put (GTK_FIXED (fixed5), button_ajm, 456, 488);
  ...
  GLADE_HOOKUP_OBJECT (aj_mesure, h, "h");
  GLADE_HOOKUP_OBJECT (aj_mesure, m, "m");
  GLADE_HOOKUP_OBJECT (aj_mesure, label27, "label27");
  GLADE_HOOKUP_OBJECT (aj_mesure, label26, "label26");
...
create_def (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed6), ajouter, 488, 504);
  gtk_widget_set_size_request (ajouter, 112, 48);

  afficher = gtk_button_new_with_mnemonic (_("Afficher"));
  gtk_widget_show (afficher);
  gtk_fixed_put (GTK_FIXED (fixed6), afficher, 248, 504);
  gtk_widget_set_size_request (afficher, 112, 48);

  label25 = gtk_label_new (_("Capteurs d\303\251fectueux"));
  ...
  GLADE_HOOKUP_OBJECT (def, ajouter, "ajouter");
  GLADE_HOOKUP_OBJECT (def, afficher, "afficher");
